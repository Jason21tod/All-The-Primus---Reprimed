...
public "handler$ffk000$onChar"(window: long, codePoint: integer, modifiers: integer, info: $CallbackInfo$$Type): void
public "handler$ffk000$onKey"(window: long, key: integer, scancode: integer, action: integer, modifiers: integer, info: $CallbackInfo$$Type): void
...
public "handler$fal001$setCameraType"(cameraType0: $CameraType$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ifm000$onGetCameraType"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type): void
...
public "handler$hek000$onSetup"(iterable: $Iterable$$Type, registryAccess: $RegistryAccess$$Type, ci: $CallbackInfo$$Type): void
...
public "handler$cmh000$iris$trackLastDimensionOnLeave"(arg: $Screen$$Type, ci: $CallbackInfo$$Type): void
public "handler$dep000$fillReport"(theCrash: $CrashReport$$Type, ci: $CallbackInfoReturnable$$Type): void
public "handler$dff000$rightClickEarly"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$dff000$rightClickEmpty"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$fbj000$init"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type): void
public "handler$fhd000$disconnectAfter"(screen_1: $Screen$$Type, info: $CallbackInfo$$Type): void
public "handler$hcj000$dragonlib$resizeDisplay"(ci: $CallbackInfo$$Type): void
public "handler$hcj000$dragonlib$showScreen"(realmsClient: $RealmsClient$$Type, reloadInstance: $ReloadInstance$$Type, quickPlayData: $GameConfig$QuickPlayData$$Type, ci: $CallbackInfo$$Type): void
public "handler$ihf000$irons_spellbooks$changeGlowOutline"(entity0: $Entity$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type): void
public "handler$iid000$startAttackEntity"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type): void
public "handler$iid000$startAttackMiss"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type): void
public "handler$ioj000$cancelItemPick"(info: $CallbackInfo$$Type): void
public "handler$zoe000$shouldEntityAppearGlowing"(entity0: $Entity$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type): void
...
public "localvar$ioj000$modifyItemPick"(stack: $ItemStack$$Type): $ItemStack
...
public "redirect$hop000$fixUpdateURLs"(renderTarget0: $RenderTarget$$Type, boolean1: boolean): void
...
public "handler$fbk000$turnPlayer"(callbackInfo0: $CallbackInfo$$Type): void
public "isLeftPressed"(): boolean
public "isMiddlePressed"(): boolean
public "isMouseGrabbed"(): boolean
public "isRightPressed"(): boolean
public "modify$dee000$changeLookDirectionX"(double0: double): double
...
public "handler$hjo000$ac_getFluidInCamera"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type): void
public "handler$hjo000$ac_onSyncedDataUpdated"(blockGetter0: $BlockGetter$$Type, entity1: $Entity$$Type, boolean2: boolean, boolean3: boolean, float4: float, callbackInfo5: $CallbackInfo$$Type): void

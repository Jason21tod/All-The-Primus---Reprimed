...
constructor(entityType0: $EntityType$$Type<$FishingHook$$Type>, level1: $Level$$Type, int2: integer, int3: integer)
...
import { $TrackedDataRegistry$$Type } from "dev.corgitaco.dataanchor.data.registry.TrackedDataRegistry"
import { $SoundAction$$Type } from "net.minecraftforge.common.SoundAction"
import { $IMixinProjectile } from "com.majruszlibrary.mixininterfaces.IMixinProjectile"
import { $AzAnimatorAccessor } from "mod.azure.azurelib.animation.AzAnimatorAccessor"
import { $Component, $Component$$Type } from "net.minecraft.network.chat.Component"
import { $ETFEntityRenderState } from "traben.entity_texture_features.features.state.ETFEntityRenderState"
import { $IProjectilsJs } from "net.liopyu.entityjs.util.implementation.IProjectilsJs"
import { $PartEntity } from "net.minecraftforge.entity.PartEntity"
import { $AttachmentType$$Type } from "net.fabricmc.fabric.api.attachment.v1.AttachmentType"
...
public "isPushedByFluid"(fluidType0: $FluidType$$Type): boolean
public "isWaterCreature"(): boolean
public static "lerpRotation"(float0: float, float1: float): float
public "majruszlibrary$getArrow"(): $ItemStack
public static "majruszlibrary$getProjectileArrow"(entity0: $Entity$$Type): $ItemStack
public static "majruszlibrary$getProjectileWeapon"(entity0: $Entity$$Type): $ItemStack
...
import { $CompoundTag, $CompoundTag$$Type } from "net.minecraft.nbt.CompoundTag"
import { $ExtraAbstractArrowItf } from "com.mega.endinglib.util.mixin.data_expand.ExtraAbstractArrowItf"
import { $BlockPos$$Type } from "net.minecraft.core.BlockPos"
import { $SoundEvent, $SoundEvent$$Type } from "net.minecraft.sounds.SoundEvent"
import { $Boat$$Type } from "net.minecraft.world.entity.vehicle.Boat"
import { $FluidState$$Type } from "net.minecraft.world.level.material.FluidState"
...
import { $LazyOptional } from "net.minecraftforge.common.util.LazyOptional"
import { $TrackedData, $TrackedData$$Type } from "dev.corgitaco.dataanchor.data.TrackedData"
import { $AccessorAbstractArrow } from "com.mega.endinglib.mixin.accessor.AccessorAbstractArrow"
import { $BiPredicate$$Type } from "java.util.function.BiPredicate"
import { $MobCategory } from "net.minecraft.world.entity.MobCategory"
import { $Component, $Component$$Type } from "net.minecraft.network.chat.Component"
import { $PartEntity } from "net.minecraftforge.entity.PartEntity"
...
import { $RayTraceResultJS } from "dev.latvian.mods.kubejs.entity.RayTraceResultJS"
import { $ScriptType } from "dev.latvian.mods.kubejs.script.ScriptType"
import { $AbstractArrowAccessor } from "dev.xkmc.l2archery.mixin.AbstractArrowAccessor"
import { $HitResult$$Type } from "net.minecraft.world.phys.HitResult"
import { $AccessorAbstractArrow as $AccessorAbstractArrow$0 } from "org.violetmoon.quark.mixin.mixins.accessor.AccessorAbstractArrow"
...
import { $EntityDimensions$$Type } from "net.minecraft.world.entity.EntityDimensions"
import { $AbstractArrowAccessor as $AbstractArrowAccessor$0 } from "com.xiaoyue.celestial_artifacts.mixin.AbstractArrowAccessor"

export class $AbstractArrow extends $Projectile implements $AccessorAbstractArrow, $ExtraAbstractArrowItf, $AbstractArrowAccessor$0, $AbstractArrowAccessor, $AccessorAbstractArrow$0, $AccessorAbstractArrowEntity {
public "addAdditionalSaveData"(compoundTag0: $CompoundTag$$Type): void
public "alwaysAccepts"(): boolean
public "attack"(hp: float): void
public "canBeRiddenUnderFluidType"(fluidType0: $FluidType$$Type, entity1: $Entity$$Type): boolean
public "canFluidExtinguish"(fluidType0: $FluidType$$Type): boolean
public "canHitEntity"(entity0: $Entity$$Type): boolean
public "canHydrateInFluidType"(fluidType0: $FluidType$$Type): boolean
public "canRiderInteract"(): boolean
public "canStartSwimming"(): boolean
public "canSwimInFluidType"(fluidType0: $FluidType$$Type): boolean
...
public "getTeamId"(): string
public "getType"(): string
public "handler$dhb000$l2library_tickDespawn_fastDespawn"(callbackInfo0: $CallbackInfo$$Type): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "isAmbientCreature"(): boolean
public "isAnimal"(): boolean
...
public "setIntangibleProjectile"(boolean0: boolean): void
...
public "vMinus$setVisionId"(resourceLocation0: $ResourceLocation$$Type): void
public "vMinus$update"(): void
public "wrapOperation$dhe000$l2backpack$playerTouch$tryArrowPickup"(inventory0: $Inventory$$Type, itemStack1: $ItemStack$$Type, operation2: $Operation$$Type): boolean
...
import { $ResourceLocation$$Type } from "net.minecraft.resources.ResourceLocation"
import { $LivingEntity$$Type } from "net.minecraft.world.entity.LivingEntity"
import { $AccessorArrow } from "com.mega.endinglib.mixin.accessor.AccessorArrow"
import { $EntityType$$Type } from "net.minecraft.world.entity.EntityType"
import { $Direction } from "net.minecraft.core.Direction"
import { $GameProfile } from "com.mojang.authlib.GameProfile"
import { $AzAnimator } from "mod.azure.azurelib.animation.AzAnimator"
...
export class $Arrow extends $AbstractArrow implements $AccessorArrow {
constructor(level0: $Level$$Type, livingEntity1: $LivingEntity$$Type)
constructor(level0: $Level$$Type, double1: double, double2: double, double3: double)
...
public "canSwimInFluidType"(fluidType0: $FluidType$$Type): boolean
public static "cast"<K, T>(t0: T): $AzAnimatorAccessor<K, T>
public "constant$dda000$apoth_getTridentDamage"(float0: float): float
public "deserializeNBT"(compoundTag0: $CompoundTag$$Type): void
public "etf$getETFRenderState"(): $ETFEntityRenderState
public static "get"<K, T>(t0: T): $Optional<$AzAnimator<K, T>>
public "getAnimator"(): $Optional<$AzAnimator<K, T>>
...
public "getTeamId"(): string
public "getType"(): string
public "handler$hmi000$moonlight$extinguishILightables"(pos: $BlockPos$$Type, ci: $CallbackInfo$$Type, state: $BlockState$$Type): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "isAmbientCreature"(): boolean
public "isAnimal"(): boolean
public "isEyeInFluidType"(fluidType0: $FluidType$$Type): boolean

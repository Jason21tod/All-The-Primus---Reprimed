...
public "constant$fnb000$placebo_unEscapeChatLogNewlines"(string0: string): string
...
public "handler$hdk000$onWidgetAdded"(widget: $GuiEventListener$$Type, cir: $CallbackInfoReturnable$$Type): void
...
public "charTyped"(char0: character, int1: integer): boolean
public "getCurrentFocusPath"(): $ComponentPath
public "handler$hdi000$onPress"(ci: $CallbackInfo$$Type): void
public "keyReleased"(int0: integer, int1: integer, int2: integer): boolean
public "mouseMoved"(double0: double, double1: double): void
public "mouseScrolled"(double0: double, double1: double, double2: double): boolean
public "setPosition"(int0: integer, int1: integer): void
...
public "handler$cml001$iris$handleHudHidingScreens"(pGui0: $GuiGraphics$$Type, pFloat1: float, ci: $CallbackInfo$$Type): void
public "handler$ian000$changeArmorItem"(guiGraphics0: $GuiGraphics$$Type, resourceLocation1: $ResourceLocation$$Type, float2: float, callbackInfo3: $CallbackInfo$$Type): void
public "handler$ieg000$irons_spellbooks$disableJumpBar"(playerRideableJumping0: $PlayerRideableJumping$$Type, guiGraphics1: $GuiGraphics$$Type, int2: integer, callbackInfo3: $CallbackInfo$$Type): void
public "handler$ieg000$irons_spellbooks$disableXpBar"(guiGraphics0: $GuiGraphics$$Type, int1: integer, callbackInfo2: $CallbackInfo$$Type): void
public "handler$ilj000$renderExperienceBar$0"(guiGraphics0: $GuiGraphics$$Type, int1: integer, callbackInfo2: $CallbackInfo$$Type): void
public "handler$ilj000$renderExperienceBar$1"(guiGraphics0: $GuiGraphics$$Type, int1: integer, callbackInfo2: $CallbackInfo$$Type): void
...
public "handler$dbm000$apoth_superMouseDragged"(double0: double, double1: double, int2: integer, double3: double, double4: double, callbackInfoReturnable5: $CallbackInfoReturnable$$Type): void
public "handler$ejb000$l2library$onClose$trackClose"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$epi000$renderSlot"(guiGraphics0: $GuiGraphics$$Type, slot1: $Slot$$Type, callbackInfo2: $CallbackInfo$$Type, itemStack3: $ItemStack$$Type): void
public "handler$epi000$renderSlotAfter"(guiGraphics0: $GuiGraphics$$Type, slot1: $Slot$$Type, callbackInfo2: $CallbackInfo$$Type): void
public "handler$fld000$renderTooltip"(guiGraphics0: $GuiGraphics$$Type, int1: integer, int2: integer, callbackInfo3: $CallbackInfo$$Type): void
public "handler$fld001$keyPressed"(int0: integer, int1: integer, int2: integer, callbackInfoReturnable3: $CallbackInfoReturnable$$Type): void
public "isFocused"(): boolean
...
public "wrapOperation$dgf000$l2backpack$renderTooltips$isEmpty"(itemStack0: $ItemStack$$Type, operation1: $Operation$$Type): boolean
...
public "handler$cpk000$render"(italic: boolean, x: float, y: float, matrix: $Matrix4f$$Type, vertexConsumer: $VertexConsumer$$Type, red: float, green: float, blue: float, alpha: float, light: integer, ci: $CallbackInfo$$Type): void

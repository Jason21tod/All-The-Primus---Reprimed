...
public "handler$fba000$onChannelStop"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$fba000$removeProcessedBuffers"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type, int1s: integer[]): void
...
public "localvar$cpf000$vertex"(alpha: float): float
...
public "getX"(): integer
public "getY"(): integer
public "handler$fjo000$onCalculateScale"(guiScaleIn: integer, forceUnicode: boolean, ci: $CallbackInfoReturnable$$Type): void

...
public "handler$hlf000$fixNotAccountingForNullPlayer1"(cir: $CallbackInfoReturnable$$Type): void
public "handler$hlf000$fixNotAccountingForNullPlayer2"(cir: $CallbackInfoReturnable$$Type): void
public "handler$hlf000$fixNotAccountingForNullPlayer3"(cir: $CallbackInfoReturnable$$Type): void
public "handler$zmn000$goety_canPlace"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type): void

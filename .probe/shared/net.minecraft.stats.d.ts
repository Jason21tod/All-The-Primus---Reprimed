...
public "handler$hei000$onLoad"(pTag: $CompoundTag$$Type, pRecipeManager: $RecipeManager$$Type, ci: $CallbackInfo$$Type): void
public "handler$hei000$onLoad"(pState: $ClientboundRecipePacket$State$$Type, pPlayer: $ServerPlayer$$Type, pRecipes: $List$$Type, ci: $CallbackInfo$$Type): void
public "handler$hei000$onSave"(cir: $CallbackInfoReturnable$$Type): void

...
public "handler$hip000$checkLocked"(mapId: integer, cir: $CallbackInfoReturnable$$Type): void
public "handler$hip000$initializeDirty"(mapItemSavedData: $MapItemSavedData$$Type, player: $Player$$Type, ci: $CallbackInfo$$Type): void
public "handler$hip000$lockData"(x: integer, z: integer, ci: $CallbackInfo$$Type): void
public "handler$hip000$sanityCheck"(x: integer, z: integer, ci: $CallbackInfo$$Type): void
public "modifyReturnValue$hip000$addExtraPacketData"(packet: $Packet$$Type, mapId: integer): $Packet
...
public "handler$hje000$checkCustomDeco"(world: $BlockGetter$$Type, x: integer, z: integer, ci: $CallbackInfo$$Type): void
public "handler$hje000$initCustomData"(i: integer, j: integer, b: byte, bl: boolean, bl2: boolean, bl3: boolean, resourceKey: $ResourceKey$$Type, ci: $CallbackInfo$$Type): void
public "handler$hje000$locked"(cir: $CallbackInfoReturnable$$Type): void
public "handler$hje000$save"(tag: $CompoundTag$$Type, cir: $CallbackInfoReturnable$$Type): void
public "handler$hje000$scaled"(cir: $CallbackInfoReturnable$$Type): void
public "handler$hje000$tickCarriedBy"(player: $Player$$Type, stack: $ItemStack$$Type, ci: $CallbackInfo$$Type): void

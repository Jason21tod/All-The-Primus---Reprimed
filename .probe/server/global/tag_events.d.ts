import { TagEventProbe } from "zzzank.probejs.generated.TagEventProbe"
...
function tags(extra: "apoli:block_action", handler: ((event: TagEventProbe<Special.Apoli$BlockActionTag, Special.Apoli$BlockAction>) => void)): void
function tags(extra: "apoli:block_condition", handler: ((event: TagEventProbe<Special.Apoli$BlockConditionTag, Special.Apoli$BlockCondition>) => void)): void
function tags(extra: "apoli:configured_bientity_action", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredBientityActionTag, Special.Apoli$ConfiguredBientityAction>) => void)): void
function tags(extra: "apoli:configured_bientity_condition", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredBientityConditionTag, Special.Apoli$ConfiguredBientityCondition>) => void)): void
function tags(extra: "apoli:configured_biome_condition", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredBiomeConditionTag, Special.Apoli$ConfiguredBiomeCondition>) => void)): void
function tags(extra: "apoli:configured_block_action", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredBlockActionTag, Special.Apoli$ConfiguredBlockAction>) => void)): void
function tags(extra: "apoli:configured_block_condition", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredBlockConditionTag, Special.Apoli$ConfiguredBlockCondition>) => void)): void
function tags(extra: "apoli:configured_damage_condition", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredDamageConditionTag, Special.Apoli$ConfiguredDamageCondition>) => void)): void
function tags(extra: "apoli:configured_entity_action", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredEntityActionTag, Special.Apoli$ConfiguredEntityAction>) => void)): void
function tags(extra: "apoli:configured_entity_condition", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredEntityConditionTag, Special.Apoli$ConfiguredEntityCondition>) => void)): void
function tags(extra: "apoli:configured_fluid_condition", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredFluidConditionTag, Special.Apoli$ConfiguredFluidCondition>) => void)): void
function tags(extra: "apoli:configured_item_action", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredItemActionTag, Special.Apoli$ConfiguredItemAction>) => void)): void
function tags(extra: "apoli:configured_item_condition", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredItemConditionTag, Special.Apoli$ConfiguredItemCondition>) => void)): void
function tags(extra: "apoli:configured_modifier", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredModifierTag, Special.Apoli$ConfiguredModifier>) => void)): void
function tags(extra: "apoli:configured_power", handler: ((event: TagEventProbe<Special.Apoli$ConfiguredPowerTag, Special.Apoli$ConfiguredPower>) => void)): void
function tags(extra: "apoli:damage_condition", handler: ((event: TagEventProbe<Special.Apoli$DamageConditionTag, Special.Apoli$DamageCondition>) => void)): void
function tags(extra: "apoli:entity_action", handler: ((event: TagEventProbe<Special.Apoli$EntityActionTag, Special.Apoli$EntityAction>) => void)): void
function tags(extra: "apoli:entity_condition", handler: ((event: TagEventProbe<Special.Apoli$EntityConditionTag, Special.Apoli$EntityCondition>) => void)): void
function tags(extra: "apoli:fluid_condition", handler: ((event: TagEventProbe<Special.Apoli$FluidConditionTag, Special.Apoli$FluidCondition>) => void)): void
function tags(extra: "apoli:global_power_set", handler: ((event: TagEventProbe<Special.Apoli$GlobalPowerSetTag, Special.Apoli$GlobalPowerSet>) => void)): void
function tags(extra: "apoli:item_action", handler: ((event: TagEventProbe<Special.Apoli$ItemActionTag, Special.Apoli$ItemAction>) => void)): void
function tags(extra: "apoli:item_condition", handler: ((event: TagEventProbe<Special.Apoli$ItemConditionTag, Special.Apoli$ItemCondition>) => void)): void
function tags(extra: "apoli:modifier", handler: ((event: TagEventProbe<Special.Apoli$ModifierTag, Special.Apoli$Modifier>) => void)): void
function tags(extra: "apoli:power_factory", handler: ((event: TagEventProbe<Special.Apoli$PowerFactoryTag, Special.Apoli$PowerFactory>) => void)): void
function tags(extra: "forge:entity_data_serializers", handler: ((event: TagEventProbe<Special.Forge$EntityDataSerializersTag, Special.Forge$EntityDataSerializers>) => void)): void
function tags(extra: "forge:fluid_type", handler: ((event: TagEventProbe<Special.Forge$FluidTypeTag, Special.Forge$FluidType>) => void)): void
function tags(extra: "forge:global_loot_modifier_serializers", handler: ((event: TagEventProbe<Special.Forge$GlobalLootModifierSerializersTag, Special.Forge$GlobalLootModifierSerializers>) => void)): void
function tags(extra: "lithostitched:modifier_predicate_type", handler: ((event: TagEventProbe<Special.Lithostitched$ModifierPredicateTypeTag, Special.Lithostitched$ModifierPredicateType>) => void)): void

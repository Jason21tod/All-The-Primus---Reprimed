...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $OptionStorage$$Type<T = any> = ($OptionStorage<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ControlElement$$Type<T = any> = ($ControlElement<T>);
}
...
import { $SpriteContents$FrameInfo$$Type } from "net.minecraft.client.renderer.texture.SpriteContents$FrameInfo"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SpriteContentsAnimationAccessor$$Type = ($SpriteContentsAnimationAccessor | (() => $List$$Type<$SpriteContents$FrameInfo$$Type>));
}

declare module "me.jellysquid.mods.sodium.client.render.chunk.terrain.material.parameters.AlphaCutoffParameter" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AlphaCutoffParameter$$Type = ($AlphaCutoffParameter | ("zero" | "one_tenth" | "half" | "one"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ModelQuadFacing$$Type = ($ModelQuadFacing | ("pos_x" | "pos_y" | "pos_z" | "neg_x" | "neg_y" | "neg_z" | "unassigned"));
}

declare module "me.jellysquid.mods.sodium.client.gui.options.Option" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Option$$Type<T = any> = ($Option<T>);
}

declare module "me.jellysquid.mods.sodium.client.render.chunk.map.ChunkTrackerHolder" {
import { $ChunkTracker$$Type } from "me.jellysquid.mods.sodium.client.render.chunk.map.ChunkTracker"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkTrackerHolder$$Type = ($ChunkTrackerHolder | (() => $ChunkTracker$$Type));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $MinecraftAccessor$$Type = ($MinecraftAccessor | (() => $Thread$$Type));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ReadableContainerExtended$$Type<T = any> = ($ReadableContainerExtended<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SpriteContentsInvoker$$Type = ($SpriteContentsInvoker | ((arg0: integer, arg1: integer, arg2: integer, arg3: integer, arg4: $NativeImage[]) => void));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Control$$Type<T = any> = ($Control<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SpriteContentsAnimationFrameAccessor$$Type = ($SpriteContentsAnimationFrameAccessor | (() => integer));
}

declare module "me.jellysquid.mods.sodium.client.world.BiomeSeedProvider" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BiomeSeedProvider$$Type = ($BiomeSeedProvider | (() => long));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkMeshAttribute$$Type = ($ChunkMeshAttribute | ("position_material_mesh" | "color_shade" | "block_texture" | "light_texture" | "normal" | "tangent" | "mid_tex_coord" | "block_id" | "mid_block"));
}
...
import { $ChunkVertexEncoder$Vertex } from "me.jellysquid.mods.sodium.client.render.chunk.vertex.format.ChunkVertexEncoder$Vertex"
import { $Material } from "me.jellysquid.mods.sodium.client.render.chunk.terrain.material.Material"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkVertexEncoder$$Type = ($ChunkVertexEncoder | ((arg0: long, arg1: $Material, arg2: $ChunkVertexEncoder$Vertex, arg3: integer) => long));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $OptionImpact$$Type = ($OptionImpact | ("low" | "medium" | "high" | "varies"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $GlVertexFormat$$Type<T extends $Enum<T> = $Enum<T>> = ($GlVertexFormat<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SpriteContentsAccessor$$Type = ($SpriteContentsAccessor | (() => $NativeImage$$Type[]));
}

declare module "me.jellysquid.mods.sodium.client.world.WorldRendererExtended" {
import { $SodiumWorldRenderer$$Type } from "me.jellysquid.mods.sodium.client.render.SodiumWorldRenderer"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $WorldRendererExtended$$Type = ($WorldRendererExtended | (() => $SodiumWorldRenderer$$Type));
}

declare module "me.jellysquid.mods.sodium.client.gui.options.OptionFlag" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $OptionFlag$$Type = ($OptionFlag | ("requires_renderer_reload" | "requires_renderer_update" | "requires_asset_reload" | "requires_game_restart"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ViewportProvider$$Type = ($ViewportProvider | (() => $Viewport$$Type));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ItemColorsExtended$$Type = ($ItemColorsExtended | ((arg0: $ItemStack) => $ItemColor$$Type));
}

declare module "me.jellysquid.mods.sodium.client.render.chunk.map.ChunkTracker$ChunkEventHandler" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkTracker$ChunkEventHandler$$Type = ($ChunkTracker$ChunkEventHandler | ((arg0: integer, arg1: integer) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $VertexFormatAccessor$$Type = ($VertexFormatAccessor | (() => $IntList$$Type));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $GlVertexFormat$Builder$$Type<T extends $Enum<T> = $Enum<T>> = ($GlVertexFormat$Builder<T>);
}

declare module "me.jellysquid.mods.sodium.client.buffer.ExtendedVertexFormat" {
import { $ExtendedVertexFormat$Element$$Type } from "me.jellysquid.mods.sodium.client.buffer.ExtendedVertexFormat$Element"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ExtendedVertexFormat$$Type = ($ExtendedVertexFormat | (() => $ExtendedVertexFormat$Element$$Type[]));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Frustum$$Type = ($Frustum | ((arg0: float, arg1: float, arg2: float, arg3: float, arg4: float, arg5: float) => boolean));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TextProvider$$Type = ($TextProvider | (() => $Component$$Type));
}

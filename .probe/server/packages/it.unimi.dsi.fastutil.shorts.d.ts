...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ShortPredicate$$Type = ($ShortPredicate | ((arg0: short) => boolean));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Short2BooleanFunction$$Type = ($Short2BooleanFunction | ((arg0: short) => boolean));
}

declare module "it.unimi.dsi.fastutil.shorts.Short2ByteFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Short2ByteFunction$$Type = ($Short2ByteFunction | ((arg0: short) => byte));
}

declare module "it.unimi.dsi.fastutil.shorts.Short2ObjectFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Short2ObjectFunction$$Type<V = any> = ($Short2ObjectFunction<V> | ((arg0: short) => V));
}

declare module "it.unimi.dsi.fastutil.shorts.Short2ShortFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Short2ShortFunction$$Type = ($Short2ShortFunction | ((arg0: short) => short));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Short2CharFunction$$Type = ($Short2CharFunction | ((arg0: short) => character));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Short2DoubleFunction$$Type = ($Short2DoubleFunction | ((arg0: short) => double));
}

declare module "it.unimi.dsi.fastutil.shorts.Short2IntFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Short2IntFunction$$Type = ($Short2IntFunction | ((arg0: short) => integer));
}

declare module "it.unimi.dsi.fastutil.shorts.Short2FloatFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Short2FloatFunction$$Type = ($Short2FloatFunction | ((arg0: short) => float));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ShortConsumer$$Type = ($ShortConsumer | ((arg0: short) => void));
}

declare module "it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Short2ReferenceFunction$$Type<V = any> = ($Short2ReferenceFunction<V> | ((arg0: short) => V));
}

declare module "it.unimi.dsi.fastutil.shorts.ShortUnaryOperator" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ShortUnaryOperator$$Type = ($ShortUnaryOperator | ((arg0: short) => short));
}

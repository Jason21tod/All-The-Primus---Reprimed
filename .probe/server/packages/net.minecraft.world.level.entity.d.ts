...
export type $LevelEntityGetter$$Type<T extends $EntityAccess = $EntityAccess> = ($LevelEntityGetter<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $LevelCallback$$Type<T = any> = ($LevelCallback<T>);
}

declare module "net.minecraft.world.level.entity.EntityTypeTest" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EntityTypeTest$$Type<B = any, T extends B = B> = ($EntityTypeTest<B, T>);
}

declare module "net.minecraft.world.level.entity.EntityPersistentStorage" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EntityPersistentStorage$$Type<T = any> = ($EntityPersistentStorage<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkStatusUpdateListener$$Type = ($ChunkStatusUpdateListener | ((arg0: $ChunkPos, arg1: $FullChunkStatus) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TransientEntitySectionManager$$Type<T extends $EntityAccess = $EntityAccess> = ($TransientEntitySectionManager<T>);
}

declare module "net.minecraft.world.level.entity.Visibility" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Visibility$$Type = ($Visibility | ("hidden" | "tracked" | "ticking"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $PersistentEntitySectionManager$$Type<T extends $EntityAccess = $EntityAccess> = ($PersistentEntitySectionManager<T>);
}

declare module "net.minecraft.world.level.entity.ChunkEntities" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkEntities$$Type<T = any> = ($ChunkEntities<T>);
}

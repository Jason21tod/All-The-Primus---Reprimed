...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $PropertyHolderBuilder$$Type = ($PropertyHolderBuilder | ((arg0: string) => $ConfigPropertyBuilder$$Type));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $KeyMappingAccessor$$Type = ($KeyMappingAccessor | (() => $InputConstants$Key$$Type));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ListConfigProperty$$Type<T = any> = ($ListConfigProperty<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfiguredList$$Type<T = any> = ($ConfiguredList<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EnumConfigProperty$$Type<T extends $Enum<T> = $Enum<T>> = ($EnumConfigProperty<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $StreamCodec$$Type<TBuffer = any, TData = any> = ($StreamCodec<TBuffer, TData>);
}

declare module "net.blay09.mods.balm.api.config.schema.ConfiguredSet" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfiguredSet$$Type<T = any> = ($ConfiguredSet<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $NestedTypeHolder$$Type<T = any> = ($NestedTypeHolder<T> | (() => $Class$$Type<T>));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SetConfigProperty$$Type<T = any> = ($SetConfigProperty<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfiguredEnum$$Type<T extends $Enum<T> = $Enum<T>> = ($ConfiguredEnum<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AbstractConfigProperty$$Type<T = any> = ($AbstractConfigProperty<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $GuiDrawEvent$Element$$Type = ($GuiDrawEvent$Element | ("all" | "health" | "chat" | "debug" | "boss_info" | "player_list"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfiguredProperty$$Type<T = any> = ($ConfiguredProperty<T>);
}

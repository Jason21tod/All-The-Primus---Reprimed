...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ObjectStartedEvent$$Type<T extends $QuestObject = $QuestObject> = ($ObjectStartedEvent<T>);
}

declare module "dev.ftb.mods.ftbteams.api.property.PrivacyMode" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $PrivacyMode$$Type = ($PrivacyMode | ("allies" | "private" | "public"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Tristate$$Type = ($Tristate | ("false" | "true" | "default"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TeamRank$$Type = ($TeamRank | ("enemy" | "none" | "ally" | "invited" | "member" | "officer" | "owner"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SelectableResource$$Type<T = any> = ($SelectableResource<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $NameMap$Builder$$Type<T = any> = ($NameMap$Builder<T>);
}
...
import { $CustomTask$Data } from "dev.ftb.mods.ftbquests.quest.task.CustomTask$Data"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $CustomTask$Check$$Type = ($CustomTask$Check | ((arg0: $CustomTask$Data, arg1: $ServerPlayer) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IResourceIcon$$Type = ($IResourceIcon | (() => $ResourceLocation$$Type));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $WidgetType$$Type = ($WidgetType | ("normal" | "mouse_over" | "disabled"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TeamPropertyValue$$Type<T = any> = ($TeamPropertyValue<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $NameMap$$Type<E = any> = ($NameMap<E>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RewardClaimType$$Type = ($RewardClaimType | ("can_claim" | "cant_claim" | "claimed"));
}

declare module "dev.ftb.mods.ftbteams.api.property.TeamProperty" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TeamProperty$$Type<T = any> = ($TeamProperty<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ProgressionMode$$Type = ($ProgressionMode | ("default" | "linear" | "flexible"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfigCallback$$Type = ($ConfigCallback | ((arg0: boolean) => void));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EnumConfig$$Type<E = any> = ($EnumConfig<E>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $WidgetLayout$$Type = ($WidgetLayout | ((arg0: $Panel) => integer));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TeamPropertyType$$Type<T = any> = ($TeamPropertyType<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $QuestProgressEventData$$Type<T extends $QuestObject = $QuestObject> = ($QuestProgressEventData<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Widget$DrawLayer$$Type = ($Widget$DrawLayer | ("background" | "foreground"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ListConfig$$Type<E = any, CV extends $ConfigValue<E> = $ConfigValue<E>> = ($ListConfig<E, CV>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IOpenableScreen$$Type = ($IOpenableScreen | (() => void));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfigWithVariants$$Type<T = any> = ($ConfigWithVariants<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ItemFTBL$$Type = ($ItemFTBL | ((arg0: $Item) => void));
}

declare module "dev.ftb.mods.ftblibrary.ui.CursorType" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $CursorType$$Type = ($CursorType | ("arrow" | "ibeam" | "crosshair" | "hand" | "hresize" | "vresize"));
}

declare module "dev.ftb.mods.ftbquests.integration.RecipeModHelper$Components" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RecipeModHelper$Components$$Type = ($RecipeModHelper$Components | ("quests" | "loot_crates"));
}

declare module "dev.ftb.mods.ftblibrary.config.ResourceConfigValue" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ResourceConfigValue$$Type<T = any> = ($ResourceConfigValue<T>);
}

declare module "dev.ftb.mods.ftbquests.quest.QuestObjectType" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $QuestObjectType$$Type = ($QuestObjectType | ("null" | "file" | "chapter" | "quest" | "task" | "reward" | "reward_table" | "chapter_group" | "quest_link"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfigValue$$Type<T = any> = ($ConfigValue<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $NumberConfig$$Type<T extends number = number> = ($NumberConfig<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RewardAutoClaim$$Type = ($RewardAutoClaim | ("default" | "disabled" | "enabled" | "no_toast" | "invisible"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Drawable$$Type = ($Drawable | ((arg0: $GuiGraphics, arg1: integer, arg2: integer, arg3: integer, arg4: integer) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RewardType$GuiProvider$$Type = ($RewardType$GuiProvider | ((arg0: $Panel, arg1: $Quest, arg2: $Consumer<$Reward>) => void));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfigFromString$$Type<T = any> = ($ConfigFromString<T>);
}
...
import { $BaseScreen$$Type } from "dev.ftb.mods.ftblibrary.ui.BaseScreen"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IScreenWrapper$$Type = ($IScreenWrapper | (() => $BaseScreen$$Type));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ObjectCompletedEvent$$Type<T extends $QuestObject = $QuestObject> = ($ObjectCompletedEvent<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TaskType$GuiProvider$$Type = ($TaskType$GuiProvider | ((arg0: $Panel, arg1: $Quest, arg2: $Consumer<$Task>) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ObjectProgressEvent$$Type<T extends $QuestObject = $QuestObject> = ($ObjectProgressEvent<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $DisplayInfoFTBL$$Type = ($DisplayInfoFTBL | (() => $ItemStack$$Type));
}

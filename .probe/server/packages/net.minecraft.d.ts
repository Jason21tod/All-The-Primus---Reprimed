...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChatFormatting$$Type = ($ChatFormatting | ("black" | "dark_blue" | "dark_green" | "dark_aqua" | "dark_red" | "dark_purple" | "gold" | "gray" | "dark_gray" | "blue" | "green" | "aqua" | "red" | "light_purple" | "yellow" | "white" | "obfuscated" | "bold" | "strikethrough" | "underline" | "italic" | "reset" | "middle" | "indigo" | "light_pink" | "pink" | "orange" | "coral" | "sky_blue" | "pine" | "plum" | "toothpaste" | "neon_yellow" | "brown" | "dark_brown" | "neon_red"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $CrashReportDetail$$Type<V = any> = ($CrashReportDetail<V> | (() => V));
}

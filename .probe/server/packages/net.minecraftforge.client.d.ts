...
import { $ForgeGui } from "net.minecraftforge.client.gui.overlay.ForgeGui"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IGuiOverlay$$Type = ($IGuiOverlay | ((arg0: $ForgeGui, arg1: $GuiGraphics, arg2: float, arg3: integer, arg4: integer) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IGeometryLoader$$Type<T extends $IUnbakedGeometry<T> = $IUnbakedGeometry<T>> = ($IGeometryLoader<T> | ((arg0: $JsonObject, arg1: $JsonDeserializationContext) => T));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IItemDecorator$$Type = ($IItemDecorator | ((arg0: $GuiGraphics, arg1: $Font, arg2: $ItemStack, arg3: integer, arg4: integer) => boolean));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfiguredModel$Builder$$Type<T = any> = ($ConfiguredModel$Builder<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RenderLivingEvent$$Type<T extends $LivingEntity = $LivingEntity, M extends $EntityModel<T> = $EntityModel<T>> = ($RenderLivingEvent<T, M>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ModelBuilder$$Type<T extends $ModelBuilder<T> = $ModelBuilder<T>> = ($ModelBuilder<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $KeyModifier$$Type = ($KeyModifier | ("control" | "shift" | "alt" | "none"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $CustomLoaderBuilder$$Type<T extends $ModelBuilder<T> = $ModelBuilder<T>> = ($CustomLoaderBuilder<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IUnbakedGeometry$$Type<T extends $IUnbakedGeometry<T> = $IUnbakedGeometry<T>> = ($IUnbakedGeometry<T> | ((arg0: $IGeometryBakingContext, arg1: $ModelBaker, arg2: $Function<$Material, $TextureAtlasSprite>, arg3: $ModelState, arg4: $ItemOverrides, arg5: $ResourceLocation) => $BakedModel$$Type));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IClientItemExtensions$FontContext$$Type = ($IClientItemExtensions$FontContext | ("item_count" | "tooltip" | "selected_item_name"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RenderLivingEvent$Pre$$Type<T extends $LivingEntity = $LivingEntity, M extends $EntityModel<T> = $EntityModel<T>> = ($RenderLivingEvent$Pre<T, M>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ModelProvider$$Type<T extends $ModelBuilder<T> = $ModelBuilder<T>> = ($ModelProvider<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RenderLivingEvent$Post$$Type<T extends $LivingEntity = $LivingEntity, M extends $EntityModel<T> = $EntityModel<T>> = ($RenderLivingEvent$Post<T, M>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IGeneratedBlockState$$Type = ($IGeneratedBlockState | (() => $JsonObject$$Type));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IArmPoseTransformer$$Type = ($IArmPoseTransformer | ((arg0: $HumanoidModel<any>, arg1: $LivingEntity, arg2: $HumanoidArm) => void));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ModelBuilder$FaceRotation$$Type = ($ModelBuilder$FaceRotation | ("zero" | "clockwise_90" | "upside_down" | "counterclockwise_90"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ModelProperty$$Type<T = any> = ($ModelProperty<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RenderBlockScreenEffectEvent$OverlayType$$Type = ($RenderBlockScreenEffectEvent$OverlayType | ("fire" | "block" | "water"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IForgeFont$$Type = ($IForgeFont | (() => $Font$$Type));
}

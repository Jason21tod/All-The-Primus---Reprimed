...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $CriterionTriggerInstance$$Type = ($CriterionTriggerInstance);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $CriterionTrigger$Listener$$Type<T extends $CriterionTriggerInstance = $CriterionTriggerInstance> = ($CriterionTrigger$Listener<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AdvancementList$Listener$$Type = ($AdvancementList$Listener);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $FrameType$$Type = ($FrameType | ("task" | "challenge" | "goal"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AdvancementList$$Type = ($AdvancementList);
}

declare module "net.minecraft.advancements.critereon.EntityTypePredicate" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EntityTypePredicate$$Type = ($EntityTypePredicate);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EntityEquipmentPredicate$$Type = ($EntityEquipmentPredicate);
}

declare module "net.minecraft.advancements.critereon.SimpleCriterionTrigger" {
import { $AbstractCriterionTriggerInstance, $AbstractCriterionTriggerInstance$$Type } from "net.minecraft.advancements.critereon.AbstractCriterionTriggerInstance"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SimpleCriterionTrigger$$Type<T extends $AbstractCriterionTriggerInstance = $AbstractCriterionTriggerInstance> = ($SimpleCriterionTrigger<T>);
}

declare module "net.minecraft.advancements.critereon.EnchantmentPredicate" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EnchantmentPredicate$$Type = ($EnchantmentPredicate);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $CriterionTrigger$$Type<T extends $CriterionTriggerInstance = $CriterionTriggerInstance> = ($CriterionTrigger<T>);
}

declare module "net.minecraft.advancements.critereon.AbstractCriterionTriggerInstance" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AbstractCriterionTriggerInstance$$Type = ($AbstractCriterionTriggerInstance);
}

declare module "net.minecraft.advancements.critereon.EntityFlagsPredicate" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EntityFlagsPredicate$$Type = ($EntityFlagsPredicate);
}

declare module "net.minecraft.advancements.Advancement" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Advancement$$Type = ($Advancement);
}

declare module "net.minecraft.advancements.AdvancementRewards" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AdvancementRewards$$Type = ($AdvancementRewards);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EntitySubPredicate$Type$$Type = ($EntitySubPredicate$Type | ((arg0: $JsonObject) => $EntitySubPredicate$$Type));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EntityPredicate$$Type = ($EntityPredicate);
}

declare module "net.minecraft.advancements.Criterion" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Criterion$$Type = ($Criterion);
}

declare module "net.minecraft.advancements.critereon.DistancePredicate" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $DistancePredicate$$Type = ($DistancePredicate);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $MinMaxBounds$$Type<T extends number = number> = ($MinMaxBounds<T>);
}

declare module "net.minecraft.advancements.critereon.LightPredicate" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $LightPredicate$$Type = ($LightPredicate);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RequirementsStrategy$$Type = ($RequirementsStrategy | ((arg0: $Collection<string>) => string[][]));
}

declare module "net.minecraft.advancements.critereon.NbtPredicate" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $NbtPredicate$$Type = ($NbtPredicate);
}

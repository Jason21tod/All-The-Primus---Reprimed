...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $JSLambdaType$BuilderBase$$Type<SELF extends $JSLambdaType$BuilderBase<SELF> = $JSLambdaType$BuilderBase<SELF>> = ($JSLambdaType$BuilderBase<SELF>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TSDump$FolderDump$$Type = ($TSDump$FolderDump);
}
...
declare module "zzzank.probejs.generated.schema.irons_spellbooks.AlchemistCauldronEmpty" {
import { $OutputItem$$Type } from "dev.latvian.mods.kubejs.item.OutputItem"
import { $InputItem$$Type } from "dev.latvian.mods.kubejs.item.InputItem"
import { $ForgeFluidRecipeJS } from "com.squoshi.irons_spells_js.util.ForgeFluidRecipeJS"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class AlchemistCauldronEmpty extends $ForgeFluidRecipeJS {
public "result"(result: $OutputItem$$Type): this
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ImportShield$$Type<T extends $BaseType = $BaseType> = ($ImportShield<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $JSMemberType$Builder$$Type<SELF extends $JSMemberType$Builder<SELF, OUT> = $JSMemberType$Builder<SELF, OUT>, OUT extends $BaseType = $BaseType> = ($JSMemberType$Builder<SELF, OUT>);
}
...
import { AlchemistCauldronEmpty } from "zzzank.probejs.generated.schema.irons_spellbooks.AlchemistCauldronEmpty"
...
import { AlchemistCauldronFill } from "zzzank.probejs.generated.schema.irons_spellbooks.AlchemistCauldronFill"
import { AlchemistCauldronBrew } from "zzzank.probejs.generated.schema.irons_spellbooks.AlchemistCauldronBrew"
import { $InputFluid$$Type } from "dev.latvian.mods.kubejs.fluid.InputFluid"
...
"parcool": {}
"almostunified": {}
"irons_spellbooks": {"alchemist_cauldron_fill": ((fluid: $OutputFluid$$Type, input: $InputItem$$Type, result: $OutputItem$$Type, mustFitAll?: boolean, sound?: string) => AlchemistCauldronFill), "alchemist_cauldron_empty": ((result: $OutputItem$$Type, input: $InputItem$$Type, fluid: $InputFluid$$Type, sound?: string) => AlchemistCauldronEmpty), "alchemist_cauldron_brew": ((results: $OutputFluid$$Type[], input: $InputItem$$Type, base_fluid: $InputFluid$$Type, byproduct?: $OutputItem$$Type) => AlchemistCauldronBrew)}
"zeta": {}
"magistuarmory": {}
"scguns": {}
"bookshelf": {}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TSArrayAccessType$$Type = ($TSArrayAccessType);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ContextShield$$Type<T extends $BaseType = $BaseType> = ($ContextShield<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ProbeNamedDump$$Type = ($ProbeNamedDump);
}

declare module "zzzank.probejs.lang.typescript.code.type.ts.TSKeyofType" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TSKeyofType$$Type = ($TSKeyofType);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $JSConfigDump$$Type = ($JSConfigDump);
}
...
declare module "zzzank.probejs.generated.schema.irons_spellbooks.AlchemistCauldronBrew" {
import { $OutputItem$$Type } from "dev.latvian.mods.kubejs.item.OutputItem"
import { $InputItem$$Type } from "dev.latvian.mods.kubejs.item.InputItem"
import { $ForgeFluidRecipeJS } from "com.squoshi.irons_spells_js.util.ForgeFluidRecipeJS"
import { $OutputFluid$$Type } from "dev.latvian.mods.kubejs.fluid.OutputFluid"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class AlchemistCauldronBrew extends $ForgeFluidRecipeJS {
public "results"(results: $OutputFluid$$Type[]): this
public "input"(input: $InputItem$$Type): this
public "base_fluid"(base_fluid: $InputFluid$$Type): this
public "byproduct"(byproduct: $OutputItem$$Type): this
}
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $UnsafeFunction$$Type<I = any, O = any, E extends $Throwable = $Throwable> = ($UnsafeFunction<I, O, E> | ((i: I) => O));
}
...
declare module "zzzank.probejs.generated.schema.irons_spellbooks.AlchemistCauldronFill" {
import { $OutputItem$$Type } from "dev.latvian.mods.kubejs.item.OutputItem"
import { $InputItem$$Type } from "dev.latvian.mods.kubejs.item.InputItem"
import { $ForgeFluidRecipeJS } from "com.squoshi.irons_spells_js.util.ForgeFluidRecipeJS"
import { $OutputFluid$$Type } from "dev.latvian.mods.kubejs.fluid.OutputFluid"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class AlchemistCauldronFill extends $ForgeFluidRecipeJS {
public "fluid"(fluid: $OutputFluid$$Type): this
public "input"(input: $InputItem$$Type): this
public "result"(result: $OutputItem$$Type): this
public "mustFitAll"(): this
public "sound"(sound: string): this
}
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ClassWrapperPJS$$Type<T = any> = ($ClassWrapperPJS<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConstructorDecl$BuilderBase$$Type<SELF extends $ConstructorDecl$BuilderBase<SELF> = $ConstructorDecl$BuilderBase<SELF>> = ($ConstructorDecl$BuilderBase<SELF>);
}

declare module "zzzank.probejs.lang.typescript.code.type.ts.TSTernaryType" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TSTernaryType$$Type = ($TSTernaryType);
}

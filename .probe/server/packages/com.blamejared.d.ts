...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AccessKeyMapping$$Type = ($AccessKeyMapping | (() => $InputConstants$Key$$Type));
}
...
import { $Renderable$$Type } from "net.minecraft.client.gui.components.Renderable"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AccessScreen$$Type = ($AccessScreen | (() => $List$$Type<$Renderable$$Type>));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $NewKeyBindsList$KeyEntry$$Type = ($NewKeyBindsList$KeyEntry);
}

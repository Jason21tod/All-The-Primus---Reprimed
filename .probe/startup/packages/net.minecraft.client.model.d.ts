...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $HumanoidModel$ArmPose$$Type = ($HumanoidModel$ArmPose | ("empty" | "item" | "block" | "bow_and_arrow" | "throw_spear" | "crossbow_charge" | "crossbow_hold" | "spyglass" | "toot_horn" | "brush" | "goety_spell" | "goety_flying" | "hold_staff" | "dwarvenhandcannon" | "irons_spellbooks_staff"));
}

...
export type $Stack$$Type<K = any> = ($Stack<K>);
}

declare module "it.unimi.dsi.fastutil.BidirectionalIterator" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BidirectionalIterator$$Type<K = any> = ($BidirectionalIterator<K>);
}

declare module "it.unimi.dsi.fastutil.Function" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Function$$Type<K = any, V = any> = ($Function<K, V> | ((arg0: any) => V));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Hash$Strategy$$Type<K = any> = ($Hash$Strategy<K>);
}

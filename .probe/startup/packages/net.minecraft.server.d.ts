...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BanListEntry$$Type<T = any> = ($BanListEntry<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $StoredUserList$$Type<K = any, V extends $StoredUserEntry<K> = $StoredUserEntry<K>> = ($StoredUserList<K, V>);
}

declare module "net.minecraft.server.level.TicketType" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TicketType$$Type<T = any> = ($TicketType<T>);
}
...
import { $PreparableReloadListener$PreparationBarrier } from "net.minecraft.server.packs.resources.PreparableReloadListener$PreparationBarrier"
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkTaskPriorityQueueSorter$Message$$Type<T = any> = ($ChunkTaskPriorityQueueSorter$Message<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $MetadataSectionSerializer$$Type<T = any> = ($MetadataSectionSerializer<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $IoSupplier$$Type<T = any> = ($IoSupplier<T> | (() => T));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SimplePreparableReloadListener$$Type<T = any> = ($SimplePreparableReloadListener<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $StoredUserEntry$$Type<T = any> = ($StoredUserEntry<T>);
}

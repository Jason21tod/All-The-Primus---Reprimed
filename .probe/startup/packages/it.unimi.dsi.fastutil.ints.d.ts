...
export type $Int2BooleanFunction$$Type = ($Int2BooleanFunction | ((arg0: integer) => boolean));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2LongFunction$$Type = ($Int2LongFunction | ((arg0: integer) => long));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2DoubleFunction$$Type = ($Int2DoubleFunction | ((arg0: integer) => double));
}

declare module "it.unimi.dsi.fastutil.ints.Int2ObjectFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2ObjectFunction$$Type<V = any> = ($Int2ObjectFunction<V> | ((arg0: integer) => V));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2ShortFunction$$Type = ($Int2ShortFunction | ((arg0: integer) => short));
}

declare module "it.unimi.dsi.fastutil.ints.Int2ObjectMap" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2ObjectMap$$Type<V = any> = ($Int2ObjectMap<V>);
}

declare module "it.unimi.dsi.fastutil.ints.Int2FloatFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2FloatFunction$$Type = ($Int2FloatFunction | ((arg0: integer) => float));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AbstractInt2ObjectFunction$$Type<V = any> = ($AbstractInt2ObjectFunction<V>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2ObjectOpenHashMap$$Type<V = any> = ($Int2ObjectOpenHashMap<V>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AbstractInt2ObjectMap$$Type<V = any> = ($AbstractInt2ObjectMap<V>);
}

declare module "it.unimi.dsi.fastutil.ints.Int2ObjectMap$FastEntrySet" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2ObjectMap$FastEntrySet$$Type<V = any> = ($Int2ObjectMap$FastEntrySet<V>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2ReferenceFunction$$Type<V = any> = ($Int2ReferenceFunction<V> | ((arg0: integer) => V));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2ObjectMap$Entry$$Type<V = any> = ($Int2ObjectMap$Entry<V>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2CharFunction$$Type = ($Int2CharFunction | ((arg0: integer) => character));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2ByteFunction$$Type = ($Int2ByteFunction | ((arg0: integer) => byte));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Int2IntFunction$$Type = ($Int2IntFunction | ((arg0: integer) => integer));
}

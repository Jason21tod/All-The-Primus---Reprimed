...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Double2ShortFunction$$Type = ($Double2ShortFunction | ((arg0: double) => short));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Double2ObjectFunction$$Type<V = any> = ($Double2ObjectFunction<V> | ((arg0: double) => V));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Double2DoubleFunction$$Type = ($Double2DoubleFunction | ((arg0: double) => double));
}

declare module "it.unimi.dsi.fastutil.doubles.Double2LongFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Double2LongFunction$$Type = ($Double2LongFunction | ((arg0: double) => long));
}

declare module "it.unimi.dsi.fastutil.doubles.Double2IntFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Double2IntFunction$$Type = ($Double2IntFunction | ((arg0: double) => integer));
}

declare module "it.unimi.dsi.fastutil.doubles.Double2ByteFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Double2ByteFunction$$Type = ($Double2ByteFunction | ((arg0: double) => byte));
}

declare module "it.unimi.dsi.fastutil.doubles.Double2FloatFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Double2FloatFunction$$Type = ($Double2FloatFunction | ((arg0: double) => float));
}

declare module "it.unimi.dsi.fastutil.doubles.Double2CharFunction" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Double2CharFunction$$Type = ($Double2CharFunction | ((arg0: double) => character));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Double2BooleanFunction$$Type = ($Double2BooleanFunction | ((arg0: double) => boolean));
}

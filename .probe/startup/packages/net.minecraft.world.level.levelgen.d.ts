...
import { $Aquifer$FluidStatus$$Type } from "net.minecraft.world.level.levelgen.Aquifer$FluidStatus"
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SurfaceRules$Condition$$Type = ($SurfaceRules$Condition | (() => boolean));
}
...
import { $IExtendedNoiseGeneratorSettings } from "terrablender.worldgen.IExtendedNoiseGeneratorSettings"
import { $NoiseGeneratorSettingsAccessor } from "dev.worldgen.lithostitched.mixin.common.NoiseGeneratorSettingsAccessor"
import { $BlockState, $BlockState$$Type } from "net.minecraft.world.level.block.state.BlockState"
import { $Record } from "java.lang.Record"
import { $ResourceKey } from "net.minecraft.resources.ResourceKey"
import { $NoiseGeneratorSettingsAccessor as $NoiseGeneratorSettingsAccessor$0 } from "com.github.alexthe666.citadel.server.generation.NoiseGeneratorSettingsAccessor"
...
export class $NoiseGeneratorSettings extends $Record implements $NoiseGeneratorSettingsAccessor$0, $NoiseGeneratorSettingsAccessor, $IExtendedNoiseGeneratorSettings {
...
public "setRegionType"(regionType0: $RegionType$$Type): void

...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Sound$Type$$Type = ($Sound$Type | ("file" | "sound_event"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $FrameSize$$Type = ($FrameSize);
}

declare module "net.minecraft.client.resources.model.ModelBakery$BakedCacheKey" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ModelBakery$BakedCacheKey$$Type = ($ModelBakery$BakedCacheKey);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ModelBakery$LoadedJson$$Type = ($ModelBakery$LoadedJson);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SoundInstance$Attenuation$$Type = ($SoundInstance$Attenuation | ("none" | "linear"));
}

declare module "net.minecraft.client.resources.language.LanguageInfo" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $LanguageInfo$$Type = ($LanguageInfo);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ModelResourceLocation$$Type = ($ModelResourceLocation);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SkinManager$SkinTextureCallback$$Type = ($SkinManager$SkinTextureCallback | ((arg0: $MinecraftProfileTexture$Type, arg1: $ResourceLocation, arg2: $MinecraftProfileTexture) => void));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AnimationMetadataSection$FrameOutput$$Type = ($AnimationMetadataSection$FrameOutput | ((arg0: integer, arg1: integer) => void));
}

...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Guard$$Type = ($Guard | ((arg0: any) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $DomainCombiner$$Type = ($DomainCombiner | ((arg0: $ProtectionDomain[], arg1: $ProtectionDomain[]) => $ProtectionDomain$$Type[]));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $PrivilegedExceptionAction$$Type<T = any> = ($PrivilegedExceptionAction<T> | (() => T));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $PrivilegedAction$$Type<T = any> = ($PrivilegedAction<T> | (() => T));
}

...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ItemPropertyFunction$$Type = ($ItemPropertyFunction | ((arg0: $ItemStack, arg1: $ClientLevel, arg2: $LivingEntity, arg3: integer) => float));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $GoalSelectorDebugRenderer$DebugGoal$$Type = ($GoalSelectorDebugRenderer$DebugGoal);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BlockElementFace$$Type = ($BlockElementFace);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $FogRenderer$FogMode$$Type = ($FogRenderer$FogMode | ("fog_sky" | "fog_terrain"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $DebugRenderer$SimpleDebugRenderer$$Type = ($DebugRenderer$SimpleDebugRenderer | ((arg0: $PoseStack, arg1: $MultiBufferSource, arg2: double, arg3: double, arg4: double) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Dumpable$$Type = ($Dumpable | ((arg0: $ResourceLocation, arg1: $Path) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $MultiBufferSource$$Type = ($MultiBufferSource | ((arg0: $RenderType) => $VertexConsumer$$Type));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkRenderDispatcher$RenderChunk$$Type = ($ChunkRenderDispatcher$RenderChunk);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BlockElementRotation$$Type = ($BlockElementRotation);
}

declare module "net.minecraft.client.renderer.chunk.ChunkRenderDispatcher$CompiledChunk" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkRenderDispatcher$CompiledChunk$$Type = ($ChunkRenderDispatcher$CompiledChunk);
}

declare module "net.minecraft.client.renderer.chunk.ChunkRenderDispatcher$RenderChunk$RebuildTask$CompileResults" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkRenderDispatcher$RenderChunk$RebuildTask$CompileResults$$Type = ($ChunkRenderDispatcher$RenderChunk$RebuildTask$CompileResults);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkRenderDispatcher$$Type = ($ChunkRenderDispatcher);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Tickable$$Type = ($Tickable | (() => void));
}

declare module "net.minecraft.client.renderer.ChunkBufferBuilderPack" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkBufferBuilderPack$$Type = ($ChunkBufferBuilderPack);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RenderType$OutlineProperty$$Type = ($RenderType$OutlineProperty | ("none" | "is_outline" | "affects_outline"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RenderLayer$$Type<T extends $Entity = $Entity, M extends $EntityModel<T> = $EntityModel<T>> = ($RenderLayer<T, M>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $LivingEntityRenderer$$Type<T extends $LivingEntity = $LivingEntity, M extends $EntityModel<T> = $EntityModel<T>> = ($LivingEntityRenderer<T, M>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BeeDebugRenderer$HiveInfo$$Type = ($BeeDebugRenderer$HiveInfo);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BrainDebugRenderer$BrainDump$$Type = ($BrainDebugRenderer$BrainDump);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EntityRenderer$$Type<T extends $Entity = $Entity> = ($EntityRenderer<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkRenderDispatcher$RenderChunk$ChunkCompileTask$$Type = ($ChunkRenderDispatcher$RenderChunk$ChunkCompileTask);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RenderLayerParent$$Type<T extends $Entity = $Entity, M extends $EntityModel<T> = $EntityModel<T>> = ($RenderLayerParent<T, M>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BeeDebugRenderer$BeeInfo$$Type = ($BeeDebugRenderer$BeeInfo);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $EntityRendererProvider$$Type<T extends $Entity = $Entity> = ($EntityRendererProvider<T> | ((arg0: $EntityRendererProvider$Context) => $EntityRenderer$$Type<T>));
}

declare module "net.minecraft.client.renderer.chunk.ChunkRenderDispatcher$ChunkTaskResult" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChunkRenderDispatcher$ChunkTaskResult$$Type = ($ChunkRenderDispatcher$ChunkTaskResult | ("successful" | "cancelled"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ItemFrameRenderer$$Type<T extends $ItemFrame = $ItemFrame> = ($ItemFrameRenderer<T>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BlockEntityRenderer$$Type<T extends $BlockEntity = $BlockEntity> = ($BlockEntityRenderer<T> | ((arg0: T, arg1: float, arg2: $PoseStack, arg3: $MultiBufferSource, arg4: integer, arg5: integer) => void));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $DimensionSpecialEffects$SkyType$$Type = ($DimensionSpecialEffects$SkyType | ("none" | "normal" | "end"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BlockModel$GuiLight$$Type = ($BlockModel$GuiLight | ("front" | "side"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BlockEntityRendererProvider$$Type<T extends $BlockEntity = $BlockEntity> = ($BlockEntityRendererProvider<T> | ((arg0: $BlockEntityRendererProvider$Context) => $BlockEntityRenderer$$Type<T>));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $SpriteLoader$Preparations$$Type = ($SpriteLoader$Preparations);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ClampedItemPropertyFunction$$Type = ($ClampedItemPropertyFunction | ((arg0: $ItemStack, arg1: $ClientLevel, arg2: $LivingEntity, arg3: integer) => float));
}

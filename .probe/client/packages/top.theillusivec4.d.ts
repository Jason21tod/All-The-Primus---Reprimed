...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AccessorEntity$$Type = ($AccessorEntity | (() => boolean));
}

declare module "top.theillusivec4.curios.api.type.capability.ICurio$DropRule" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ICurio$DropRule$$Type = ($ICurio$DropRule | ("default" | "always_drop" | "always_keep" | "destroy"));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ICurio$$Type = ($ICurio | (() => $ItemStack$$Type));
}

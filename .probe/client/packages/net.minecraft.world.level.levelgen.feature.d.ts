...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $FeaturePlaceContext$$Type<FC extends $FeatureConfiguration = $FeatureConfiguration> = ($FeaturePlaceContext<FC>);
}
...
export class $FeatureSizeType<P extends $FeatureSize = $FeatureSize> {
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $FeatureSizeType$$Type<P extends $FeatureSize = $FeatureSize> = ($FeatureSizeType<P> | Special.WorldgenFeatureSizeType);
}
...
export class $TrunkPlacerType<P extends $TrunkPlacer = $TrunkPlacer> {
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TrunkPlacerType$$Type<P extends $TrunkPlacer = $TrunkPlacer> = ($TrunkPlacerType<P> | Special.WorldgenTrunkPlacerType);
}
...
export class $FoliagePlacerType<P extends $FoliagePlacer = $FoliagePlacer> {
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $FoliagePlacerType$$Type<P extends $FoliagePlacer = $FoliagePlacer> = ($FoliagePlacerType<P> | Special.WorldgenFoliagePlacerType);
}
...
export class $BlockStateProviderType<P extends $BlockStateProvider = $BlockStateProvider> {
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BlockStateProviderType$$Type<P extends $BlockStateProvider = $BlockStateProvider> = ($BlockStateProviderType<P> | Special.WorldgenBlockStateProviderType);
}
...
export class $TreeDecoratorType<P extends $TreeDecorator = $TreeDecorator> {
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TreeDecoratorType$$Type<P extends $TreeDecorator = $TreeDecorator> = ($TreeDecoratorType<P> | Special.WorldgenTreeDecoratorType);
}
...
export class $ConfiguredFeature<FC extends $FeatureConfiguration = $FeatureConfiguration, F extends $Feature<FC> = $Feature<FC>> extends $Record {
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ConfiguredFeature$$Type<FC extends $FeatureConfiguration = $FeatureConfiguration, F extends $Feature<FC> = $Feature<FC>> = ($ConfiguredFeature<FC, F> | Special.WorldgenConfiguredFeature);
}
...
export class $RootPlacerType<P extends $RootPlacer = $RootPlacer> {
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RootPlacerType$$Type<P extends $RootPlacer = $RootPlacer> = ($RootPlacerType<P> | Special.WorldgenRootPlacerType);
}
...
export class $Feature<FC extends $FeatureConfiguration = $FeatureConfiguration> {
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Feature$$Type<FC extends $FeatureConfiguration = $FeatureConfiguration> = ($Feature<FC> | Special.WorldgenFeature);
}

...
declare module "net.minecraft.world.item.BowlFoodItem" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
declare module "net.minecraft.world.item.ItemStack$TooltipPart" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
import { $CreativeModeTab$TabVisibility } from "net.minecraft.world.item.CreativeModeTab$TabVisibility"
...
declare module "net.minecraft.world.item.EnchantedGoldenAppleItem" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
declare module "net.minecraft.world.item.ArmorMaterials" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
declare module "net.minecraft.world.item.RecordItem" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Rarity$$Type = ($Rarity | ("common" | "uncommon" | "rare" | "epic" | "alexscavesexemplified:gamma" | "traveloptics:legendary" | "traveloptics:mythic" | "traveloptics:signature" | "traveloptics:abyssal" | "traveloptics:ancient" | "traveloptics:cursed" | "traveloptics:mechanized" | "traveloptics:natural" | "traveloptics:ignis" | "traveloptics:amethyst" | "traveloptics:void" | "traveloptics:toxic" | "traveloptics:tectonic" | "traveloptics:retro" | "traveloptics:primordial" | "traveloptics:eldritch" | "traveloptics:monstrous" | "traveloptics:aquatic" | "traveloptics:frosted" | "traveloptics:magnetic" | "traveloptics:scylla" | "legendary" | "alexscaves:demonic" | "alexscaves:nuclear" | "alexscaves:sweet" | "alexscaves:rainbow" | "red" | "green" | "gold" | "yellow" | "blue" | "pink" | "dark_green" | "dark_purple" | "dark_aqua" | "celestial" | "ethereal" | "irons_spellbooks_cinderous" | "inverted" | "unobtainable" | "delicacy" | "scguns.oceanic" | "scguns.unique" | "scguns.piglish" | "scguns.scorched" | "scguns.deep_dark" | "scguns.endish" | "scguns.bizarre" | "scguns.treated_brass" | "scguns.diamond_steel" | "scguns.wrecker" | "scguns.rusty"));
}
...
declare module "net.minecraft.world.item.DyeableHorseArmorItem" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
declare module "net.minecraft.world.item.DyeableArmorItem" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
declare module "net.minecraft.world.item.SimpleFoiledItem" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
declare module "net.minecraft.world.item.HorseArmorItem" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
declare module "net.minecraft.world.item.DyeableLeatherItem" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
import { $CreativeModeTab$ItemDisplayParameters } from "net.minecraft.world.item.CreativeModeTab$ItemDisplayParameters"
...
declare module "net.minecraft.world.item.FireworkRocketItem$Shape" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $FireworkRocketItem$Shape$$Type = ($FireworkRocketItem$Shape | ("small_ball" | "large_ball" | "star" | "creeper" | "burst"));
}

declare module "net.minecraft.world.item.Vanishable" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
...
import { $ItemSteerable, $ItemSteerable$$Type } from "net.minecraft.world.entity.ItemSteerable"
import { $Entity, $Entity$$Type } from "net.minecraft.world.entity.Entity"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $FoodOnAStickItem$$Type<T extends ($Entity & $ItemSteerable) = ($Entity & $ItemSteerable)> = ($FoodOnAStickItem<T>);
}
...
import { $FabricItemGroup } from "net.fabricmc.fabric.impl.itemgroup.FabricItemGroup"
import { $Collection, $Collection$$Type } from "java.util.Collection"
import { $CreativeModeTabKJS } from "dev.latvian.mods.kubejs.core.CreativeModeTabKJS"
import { $Consumer$$Type } from "java.util.function.Consumer"
import { $CreativeModeTab$Builder } from "net.minecraft.world.item.CreativeModeTab$Builder"
import { $List, $List$$Type } from "java.util.List"
import { $CreativeTabModeAccessor } from "net.lixir.vminus.mixins.creative.CreativeTabModeAccessor"
...
export class $CreativeModeTab implements $CreativeTabModeAccessor, $FabricItemGroup, $CreativeModeTabKJS, $VisionDuck {
...
public "setPage"(page: integer): void

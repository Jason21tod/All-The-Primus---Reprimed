...
export type $AccessorPlayer$$Type = ($AccessorPlayer | ((arg0: integer) => void));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $AccessorAbstractFurnaceBlockEntity$$Type = ($AccessorAbstractFurnaceBlockEntity | (() => $NonNullList$$Type<$ItemStack$$Type>));
}

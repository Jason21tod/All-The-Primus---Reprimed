...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChatReportBuilder$ChatReport$$Type = ($ChatReportBuilder$ChatReport);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $LoggedChatEvent$Type$$Type = ($LoggedChatEvent$Type | ("player" | "system"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ServerData$ServerPackStatus$$Type = ($ServerData$ServerPackStatus | ("enabled" | "disabled" | "prompt"));
}
...
import { $LoggedChatEvent$Type$$Type } from "net.minecraft.client.multiplayer.chat.LoggedChatEvent$Type"

/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $LoggedChatEvent$$Type = ($LoggedChatEvent | (() => $LoggedChatEvent$Type$$Type));
}

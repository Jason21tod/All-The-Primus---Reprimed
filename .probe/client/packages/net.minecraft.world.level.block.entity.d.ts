...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ChestLidController$$Type = ($ChestLidController);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BlockEntityType$BlockEntitySupplier$$Type<T extends $BlockEntity = $BlockEntity> = ($BlockEntityType$BlockEntitySupplier<T> | ((arg0: $BlockPos, arg1: $BlockState) => T));
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BlockEntityTicker$$Type<T extends $BlockEntity = $BlockEntity> = ($BlockEntityTicker<T> | ((arg0: $Level, arg1: $BlockPos, arg2: $BlockState, arg3: T) => void));
}
...
import { $BlockEntityTypeAccessor } from "net.fabricmc.fabric.mixin.lookup.BlockEntityTypeAccessor"
...
import { $EnchantmentTableBlockEntity } from "net.minecraft.world.level.block.entity.EnchantmentTableBlockEntity"
...
export class $BlockEntityType<T extends $BlockEntity = $BlockEntity> implements $IWhitelistCheck, $DynamicLightHandlerHolder, $BlockEntityTypeAccessor {
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $BlockEntityType$$Type<T extends $BlockEntity = $BlockEntity> = ($BlockEntityType<T> | Special.BlockEntityType);
}

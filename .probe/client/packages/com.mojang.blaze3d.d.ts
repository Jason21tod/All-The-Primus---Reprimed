...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $VertexFormatElement$Usage$$Type = ($VertexFormatElement$Usage | ("position" | "normal" | "color" | "uv" | "padding" | "generic"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $VertexFormat$Mode$$Type = ($VertexFormat$Mode | ("lines" | "line_strip" | "debug_lines" | "debug_line_strip" | "triangles" | "triangle_strip" | "triangle_fan" | "quads"));
}

declare module "com.mojang.blaze3d.vertex.VertexFormatElement$Type" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $VertexFormatElement$Type$$Type = ($VertexFormatElement$Type | ("float" | "ubyte" | "byte" | "ushort" | "short" | "uint" | "int"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $VertexFormat$IndexType$$Type = ($VertexFormat$IndexType | ("short" | "int"));
}

...
export type $AttachedData$$Type<T = any> = ($AttachedData<T>);
}

declare module "dev.latvian.mods.kubejs.util.RotationAxis" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $RotationAxis$$Type = ($RotationAxis | ("xn" | "xp" | "yn" | "yp" | "zn" | "zp"));
}

declare module "dev.latvian.mods.kubejs.util.TinyMap$Entry" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TinyMap$Entry$$Type<K = any, V = any> = ($TinyMap$Entry<K, V>);
}
...
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ScheduledEvents$Callback$$Type = ($ScheduledEvents$Callback | ((arg0: $ScheduledEvents$ScheduledEvent) => void));
}

declare module "dev.latvian.mods.kubejs.util.TinyMap" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $TinyMap$$Type<K = any, V = any> = ($TinyMap<K, V>);
}

declare module "dev.latvian.mods.kubejs.util.NotificationBuilder" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $NotificationBuilder$$Type = ($NotificationBuilder);
}

declare module "dev.latvian.mods.kubejs.util.LogType" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $LogType$$Type = ($LogType | ("init" | "debug" | "info" | "warn" | "error"));
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $ClassWrapper$$Type<T = any> = ($ClassWrapper<T>);
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Use `Internal.{Type}` and `Internal.{Type}_` for referencing this type in JS file */
export type $Lazy$$Type<T = any> = ($Lazy<T>);
}
